...
/*
Vérifie que le joueur a fourni un fichier .ber.

Vérifie que ce fichier est valide et charge la carte.

Vérifie la validité de la carte.

Initialise les variables et MiniLibX.

Crée une fenêtre adaptée à la taille de la carte.

Affiche la carte à l’écran.

Gère les événements (clavier, fermeture, animation).

Lance la boucle du jeu jusqu’à la fermeture.
*/
